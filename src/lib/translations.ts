...
export const translations: AppTranslations = {
  en: {
    ...
    AssignmentSummaryActiveOnly: "Active assignments only",
    ...
    AssignmentSummaryUnassigned: "Active unassigned",
    AssignmentSummaryFilteredDescription: "Showing active assignments for this workload view.",
  ...
  ro: {
    ...
    AssignmentSummaryActiveOnly: "Doar sarcini active",
    ...
    AssignmentSummaryUnassigned: "Active nealocate",
    AssignmentSummaryFilteredDescription: "Se afișează sarcinile active pentru această perspectivă.",
