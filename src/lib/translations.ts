...
export const translations: AppTranslations = {
  en: {
    ...
    AssignmentOnlyAdminCanUndoStart: "You do not have permission to return started work to pending.",
    AssignmentCannotReopenCompleted: "You do not have permission to reopen completed work.",
  ...
  ro: {
    ...
    AssignmentOnlyAdminCanUndoStart: "Nu ai permisiunea de a readuce lucrul început în așteptare.",
    AssignmentCannotReopenCompleted: "Nu ai permisiunea de a redeschide lucrul finalizat.",
