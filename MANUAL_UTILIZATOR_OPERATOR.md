...
![Pagina de autentificare WorkSmart](docs/manual/screenshots/operator/01-autentificare.png)
...
![Avertizarea pentru parola temporară](docs/manual/screenshots/operator/02-parola-temporara.png)
...
![Antetul aplicației pe desktop](docs/manual/screenshots/operator/03-antet-desktop.png)

*Antetul Operatorului pe desktop.*

![Meniul mobil al Operatorului](docs/manual/screenshots/operator/04-meniu-mobil.png)
...
![Notificare în timp real pentru o sarcină nouă](docs/manual/screenshots/operator/05-notificare-timp-real.png)
...
![Lista notificărilor](docs/manual/screenshots/operator/06-centru-notificari.png)
...
![Rezumatul personal al Operatorului](docs/manual/screenshots/operator/07-rezumat-personal.png)
...
![Calendarul sarcinilor](docs/manual/screenshots/operator/08-calendar-sarcini.png)
...
![Detaliile complete ale unei sarcini](docs/manual/screenshots/operator/09-detalii-sarcina.png)
...
![Cele trei stări ale unei sarcini](docs/manual/screenshots/operator/10-stari-sarcina.png)
...
![Sarcină finalizată cu întârziere](docs/manual/screenshots/operator/11-finalizare-intarziata.png)
...
![Programul echipei și prezența online](docs/manual/screenshots/operator/12-program-echipa-online.png)
...
![Statisticile Operatorului](docs/manual/screenshots/operator/14-setari-statistici.png)
