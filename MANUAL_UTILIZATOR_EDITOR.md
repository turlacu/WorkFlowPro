...
![Pagina de autentificare WorkSmart](docs/manual/screenshots/editor/01-autentificare.png)
...
![Avertizarea pentru parola temporară](docs/manual/screenshots/editor/02-parola-temporara.png)
...
![Antetul aplicației pentru Editor](docs/manual/screenshots/editor/03-antet-desktop.png)

*Antetul Editorului pe desktop.*

![Meniul mobil al Editorului](docs/manual/screenshots/editor/04-meniu-mobil.png)
...
![Rezumatul echipei și filtrul de restanțe](docs/manual/screenshots/editor/05-rezumat-echipa-restante.png)
...
![Lista sarcinilor și calendarul](docs/manual/screenshots/editor/06-lista-sarcini-calendar.png)
...
![Butonul Sarcină Nouă](docs/manual/screenshots/editor/07-buton-sarcina-noua.png)
...
![Formularul pentru o sarcină nouă](docs/manual/screenshots/editor/08-formular-sarcina-noua.png)
...
![Calendarul formularului de sarcină](docs/manual/screenshots/editor/09-calendar-fara-date-trecute.png)
...
![Confirmarea creării unei sarcini](docs/manual/screenshots/editor/10-confirmare-creare.png)
...
![Editarea unei sarcini](docs/manual/screenshots/editor/11-editare-sarcina.png)
...
![Data-limită blocată după finalizare](docs/manual/screenshots/editor/12-data-limita-blocata.png)
...
![Confirmarea ștergerii unei sarcini](docs/manual/screenshots/editor/13-confirmare-stergere.png)
...
![Sarcină restantă și sarcină finalizată târziu](docs/manual/screenshots/editor/14-restanta-si-finalizata-tarziu.png)
...
![Programul echipei și prezența online](docs/manual/screenshots/editor/15-program-echipa-online.png)
...
![Statisticile Editorului](docs/manual/screenshots/editor/19-setari-statistici.png)
